from opencep.parallel.data_parallel.DataParallelExecutionAlgorithmFactory import \
    DataParallelExecutionAlgorithmFactory, ABC
from opencep.parallel.manager.ParallelEvaluationManager import ParallelEvaluationManager
