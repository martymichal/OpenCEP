...
from opencep.base.PatternStructure import NegationOperator, AndOperator, SeqOperator, KleeneClosureOperator, \
    PrimitiveEventStructure
from opencep.plan.TreePlan import TreePlanBinaryNode, TreePlanLeafNode, TreePlanNode, OperatorTypes, TreePlanUnaryNode, \
