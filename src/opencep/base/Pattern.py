...
from opencep.condition.Condition import Condition, Variable, BinaryCondition, TrueCondition
from opencep.condition.CompositeCondition import CompositeCondition, AndCondition
from opencep.base.PatternStructure import PatternStructure, CompositeStructure, PrimitiveEventStructure, \
